...
non_x_name = ["t","y","y_f","y_cf"]
x_name = list(set(moniColumns) - set(non_x_name))
x_dim = len(x_name)
...
for i in range(100):
    ...
    GSCM_predict_delta = wgan.predict([input_t - 0.1, input_c])[1]
    ...
    GSCM_predict_test_delta_ = wgan.predict([input_t_test - 0.1, input_c_test])[1]
